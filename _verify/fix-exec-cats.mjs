...
const TARGETS = [
  { file: "image---b684441a-95d5-4d80-8a7b-0fe3939aa9f2.png", out: "exec-cat-must.png", name: "必须完成" },
  { file: "image---75254508-4b30-4488-8921-bbdfb19d00bd.png", out: "exec-cat-doing.png", name: "进行中" },
  { file: "image---d3bdbf0f-da98-4048-a671-b6e8fd5fb9fa.png", out: "exec-cat-waiting.png", name: "等待处理" },
];
