...
const TARGETS = [
  { file: "image---51db0f6f-46d2-412a-9393-59eee45652ab.png", out: "study-cat-learn.png", name: "今日学习" },
  { file: "image---636b8dfb-5d14-466f-a37f-21f1bf6caeb1.png", out: "study-cat-plan.png", name: "学习计划" },
  { file: "image---090a90e4-9d7d-45d9-a7a1-9d60b219c31f.png", out: "study-cat-card.png", name: "知识卡片" },
];
